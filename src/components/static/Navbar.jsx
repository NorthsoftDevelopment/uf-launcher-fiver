...
export const Navbar = () => {
  ...
  function action(btn) {
    ...
    attr == "min" ? ipcRenderer.send("window_minimize") : attr=="max" ? ipcRenderer.send("window_maximize") : attr == "close" ? ipcRenderer.send("window_close") : ""
  ...
  return (
    <div className="navbar drag">
      ...
      <Link to="/" >
        ...
        <Link to="/instances">
        <div className="navbar-item nodrag">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            height="24"
